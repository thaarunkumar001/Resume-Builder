    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['address'] = [ 
                ...
                $form['educationqualification'] = [ 
                    '#type' => 'textarea', 
                    '#title' => $this->t('Enter Qualification'), 
                    '#required' => TRUE, ];
                    $form['postgraduation'] = [ 
                        '#type' => 'number', 
...
//         $name = $form_state->getValue(['basic_details', 'name']);
// $email = $form_state->getValue(['basic_details', 'email']);
// $phone = $form_state->getValue(['basic_details', 'phone']);
// $address = $form_state->getValue(['basic_details', 'address']);

// $postgraduation = $form_state->getValue(['educational_qualification', 'postgraduation']);
// $undergraduate = $form_state->getValue(['educational_qualification', 'undergraduate']);
// $tentn = $form_state->getValue(['educational_qualification', 'tentn']);

// $internship = $form_state->getValue(['others', 'internship']);
// $skills = $form_state->getValue(['others', 'skills']);
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            $sql = "INSERT INTO basicdata(rname, remail, phone,raddress,postgraduation,graduation,tenthmark,InternshipDetails,skills) VALUES ('$name', '$email','$phoneno','$address','$postgraduation','$undergraduate','$tenth','$internship','$skills')";
